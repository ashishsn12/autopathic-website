    ...
    <section id="contact" className="py-20 md:py-32 bg-foreground text-white" ref={ref}>
      <div className="container-custom mx-auto px-6">
        <div className="mb-16 text-center max-w-3xl mx-auto scroll-animate opacity-0 translate-y-8 transition-all duration-600">
          <h2 className="font-serif font-bold text-white text-[clamp(28px,4vw,44px)] leading-tight mb-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Dashboards" className="text-foreground">Dashboards</option>
                    <option value="Process Automation" className="text-foreground">Process Automation</option>
                    <option value="Website" className="text-foreground">Website</option>
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    className="w-full bg-primary text-white font-sans font-semibold text-[16px] px-[32px] py-[14px] rounded-md transition-all duration-300 hover:shadow-[0_0_18px_rgba(13,148,136,0.55)] hover:-translate-y-[2px] hover:bg-[#0f9f93]"
                  >
                    Send Message
                  </button>
